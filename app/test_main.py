...
@pytest.mark.parametrize(
    "mocked_today, products, expected",
    [
        (
...
def test_outdated_products(mocked_today, products, expected):
    with patch("app.main.datetime.date.today", return_value=mocked_today):
